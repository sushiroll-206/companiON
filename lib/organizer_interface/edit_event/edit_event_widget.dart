                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                    ...
                                    text: editEventEventsRecord.name,
                                  ),
                              ...
                              Text(
                                valueOrDefault<String>(
                                  editEventEventsRecord.address?.toString(),
                                  'No address selected',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                ...
                                children: [
                                  Text(
                                    dateTimeFormat('MMMMEEEEd',
                                        editEventEventsRecord.dateStart!),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                          fontFamily: 'Lato',
                                  ...
                                  Text(
                                    dateTimeFormat(
                                        'jm', editEventEventsRecord.startTime!),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                          fontFamily: 'Lato',
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    dateTimeFormat(
                                        'jm', editEventEventsRecord.endTime!),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                          fontFamily: 'Lato',
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.textFieldMaxNumTextController ??=
                                            TextEditingController(
                                      text: editEventEventsRecord.companionLimit
                                          .toString(),
                                    ),
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller: _model
                                      ...
                                      TextEditingController(
                                    text: editEventEventsRecord.description,
                                  ),
                                  focusNode:
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FlutterFlowDropDown<String>(
                                      controller: _model
                                              .dropDownContactValueController ??=
                                          FormFieldController<String>(
                                        _model.dropDownContactValue ??=
                                            editEventEventsRecord.contactType,
                                      ),
                                      options: const [
                                        'Email',
                                        'Phone Number',
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model.dropDownContactValue ==
                                            null) {
                                          return;
                                        }
