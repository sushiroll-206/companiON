...
import '/event_view/event_full/event_full_widget.dart';
...
class _EventScreenWidgetState extends State<EventScreenWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventScreenModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EventsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final eventScreenEventsRecord = snapshot.data!;
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 10.0),
                                  child: Text(
                                    '${dateTimeFormat('MMMMEEEEd', eventScreenEventsRecord.dateStart)} | ${dateTimeFormat('jm', eventScreenEventsRecord.startTime)} - ${dateTimeFormat('jm', eventScreenEventsRecord.endTime)}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Lato',
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if ((eventScreenEventsRecord
                                          ...
                                          eventScreenEventsRecord
                                              .companionLimit) &&
                                      (eventScreenEventsRecord.companionLimit >
                                          0)) {
